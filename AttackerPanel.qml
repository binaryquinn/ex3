...
import QtQuick.Controls.Styles 1.2
    ...
    Item{
        id: item1
            ...
            InputPanel{
                id:proactiveInput
                anchors.bottom: rollChoice.bottom
                anchors.left:parent.left
                visible:rollChoice.visible && rollChoice.checked
            ...
            InputPanel{
                ...
                anchors.bottom: rollChoice.bottom
                anchors.right:parent.right
                visible:rollChoice.visible && rollChoice.checked && !!defender
            }
        }
        Switch {
            visible: complete
            ...
            onCheckedChanged: {
                var results=[{"choice":""}];
                results.choice= rollChoice.checked
                if(rollChoice.checked)
                {
                    actionResults(index,-1)
                }
            }
        }
    }
